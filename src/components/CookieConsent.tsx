// Standard cookie consent banner — required for EU GDPR + India DPDP Act compliance.
// Imported in src/app/layout.tsx so it appears on every page.
...
export function CookieConsent() {
  ...
  const accept = () => {
    ...
    setShow(false);
    // Update GA4 consent if it's loaded
  ...
  return (
    ...
    >
      <div className="text-sm text-gray-700 mb-3">
        We use cookies for login, analytics, and to improve IPOpulse. See our{" "}
