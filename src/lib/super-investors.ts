...
export const superInvestors: SuperInvestor[] = [
  ...
  {
    slug: "nikhil-kamath",
    name: "Nikhil Kamath (Zerodha / True Beacon)",
    shortName: "Nikhil Kamath",
    bio: "Co-founder of Zerodha and True Beacon. Quantitative and alternative investing approach. One of India's youngest billionaires.",
    alive: true,
    approxPortfolioCr: 4500,
    holdings: [
      { company: "Zerodha Fund House ETFs", pctHeld: 0, valueCr: 2000, qoqChange: "same" },
    ],
    asOf: "Dec 2025 filings",
  },
  {
    slug: "mohnish-pabrai",
    name: "Mohnish Pabrai",
    shortName: "Mohnish Pabrai",
    bio: "Pabrai Investment Funds. Value investor, Buffett disciple. Invested in India via Dalal Street. Concentrated bets in beaten-down businesses.",
    alive: true,
    approxPortfolioCr: 3800,
    holdings: [
      { company: "Rain Industries", pctHeld: 7.5, valueCr: 520, qoqChange: "same" },
      { company: "Edelweiss Financial", pctHeld: 3.2, valueCr: 380, qoqChange: "added" },
      { company: "Kolte Patil Developers", pctHeld: 5.1, valueCr: 290, qoqChange: "same" },
    ],
    asOf: "Dec 2025 filings",
  },
  {
    slug: "shankar-sharma",
    name: "Shankar Sharma",
    shortName: "Shankar Sharma",
    bio: "Co-founder of First Global. Contrarian investor. Known for bold macro calls and emerging market focus.",
    alive: true,
    approxPortfolioCr: 1800,
    holdings: [
      { company: "Multi Commodity Exchange", pctHeld: 1.2, valueCr: 220, qoqChange: "same" },
    ],
    asOf: "Dec 2025 filings",
  },
  {
    slug: "sanjiv-bhatt",
    name: "Sanjiv Bhatt (Carnelian Capital)",
    shortName: "Sanjiv Bhatt",
    bio: "Founder of Carnelian Capital. Early-stage and emerging businesses focus. Known for quality-at-right-price approach.",
    alive: true,
    approxPortfolioCr: 2200,
    holdings: [
      { company: "Radico Khaitan", pctHeld: 1.1, valueCr: 220, qoqChange: "same" },
      { company: "Carborundum Universal", pctHeld: 1.4, valueCr: 180, qoqChange: "added" },
    ],
    asOf: "Dec 2025 filings",
  },
  {
    ...
    shortName: "George Muthoot",
    bio: "MD of Muthoot Finance. Family-held gold lending empire. Promoter portfolio represents one of India's largest NBFC groups.",
    alive: true,
    approxPortfolioCr: 28000,
    holdings: [
      { company: "Muthoot Finance", pctHeld: 73.5, valueCr: 28000, qoqChange: "same" },
    ],
    asOf: "Dec 2025 filings",
  },
  {
    slug: "raamdeo-agrawal",
    name: "Raamdeo Agrawal (Motilal Oswal)",
    shortName: "Raamdeo Agrawal",
    bio: "Co-founder of Motilal Oswal Financial Services. QGLP investor (Quality, Growth, Longevity, Price). Annual Wealth Creation Studies author.",
    alive: true,
    approxPortfolioCr: 5500,
    holdings: [
      { company: "HDFC Bank", pctHeld: 0.1, valueCr: 1200, qoqChange: "same" },
      { company: "Page Industries", pctHeld: 0.8, valueCr: 230, qoqChange: "same" },
      { company: "Eicher Motors", pctHeld: 0.4, valueCr: 280, qoqChange: "same" },
    ],
    asOf: "Dec 2025 filings",
  },
  {
    slug: "nemish-shah",
    name: "Nemish Shah (ENAM Holdings)",
    shortName: "Nemish Shah",
    bio: "Co-founder of ENAM Holdings. Long-term value investing in Indian equities. Rarely public but consistently in top institutional disclosures.",
    alive: true,
    approxPortfolioCr: 4200,
    holdings: [
      { company: "ITC", pctHeld: 1.2, valueCr: 680, qoqChange: "same" },
      { company: "Larsen & Toubro", pctHeld: 0.4, valueCr: 220, qoqChange: "same" },
    ],
    asOf: "Dec 2025 filings",
  },
  {
    slug: "samir-arora",
    name: "Samir Arora (Helios Capital)",
    shortName: "Samir Arora",
    bio: "Founder of Helios Capital, Singapore. India-focused long-short equity fund. Highly vocal on Twitter, known for contrarian opinions.",
    alive: true,
    approxPortfolioCr: 8500,
    holdings: [
      { company: "HDFC Bank", pctHeld: 0.2, valueCr: 1800, qoqChange: "same" },
      { company: "Infosys", pctHeld: 0.2, valueCr: 1400, qoqChange: "same" },
    ],
    asOf: "Dec 2025 filings",
  },
  {
    slug: "kenneth-andrade",
    name: "Kenneth Andrade (Old Bridge Capital)",
    shortName: "Kenneth Andrade",
    bio: "Founder of Old Bridge Capital. Former CIO at IDFC MF. Focus on capital efficiency, B2B businesses, and contrarian large-cap picks.",
    alive: true,
    approxPortfolioCr: 3100,
    holdings: [
      { company: "Bharat Electronics", pctHeld: 0.6, valueCr: 380, qoqChange: "same" },
      { company: "Persistent Systems", pctHeld: 0.5, valueCr: 260, qoqChange: "added" },
    ],
    asOf: "Dec 2025 filings",
  },
];
